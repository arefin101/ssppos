...
const Navdata = () => {
    ...
    const [averagePurchasePrice, setAveragePurchasePrice] = useState(false)
    ...
    useEffect(() =>{
        if(permissions_role){
            ...
            if(permissions_role.includes('purchase-variation.avg-purchase-price') || permissions_role == 'all'){
                setAveragePurchasePrice(true)
            }
            if(purchaseListVisibility || purchaseVariationsVisibility || averagePurchasePrice ){
            ...
            if(expenseCategoriesVisibility || expenseReferencesVisibility || expenseListVisibility ){
            ...
            if(saleListVisibility || saleTerminalVisibility ){
        ...
        },
        {
            ...
            subItems: [
                ...
                
                {
                    ...
                    visibility:averagePurchasePrice,
