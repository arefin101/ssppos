...
const authProtectedRoutes = [
    ...
    // { path: "/dashboard-analytics", component: DashboardAnalytics ,permission:"123" },
    // { path: "/dashboard-crm", component: DashboardCrm ,xyz:"123"},
    ...
    {path: "/variation-list/:id", component:VariationList, permission: "purchase-variation.index"},
...
const publicRoutes = [
    ...
    { path: "/forgot-password", component: ForgetPasswordPage , permission:"all"},
