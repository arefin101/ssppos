              ...
              <tr>
                  ...
                  <td>
                      <span className="text-dark fs-16 ">
                        ${page.map(data => data.original).reduce((total, row) =>  total = total + parseFloat(row.total_payable), 0 ).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                      </span>
                  </td>
                  <td>
                      <span className="text-dark fs-16 ">
                        ${page.map(data => data.original).reduce((total, row) =>  total = total + parseInt(row.paid), 0 ).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}
                      </span>
                  </td>
                  <td colSpan="4"></td>
              </tr>
