...
const TableContainer = ({ columns, data, isGlobalSearch, customPageSize, tableClass, theadClass, thClass, divClass, setFilteredData, isExtraFeature, maxLength, filteredLength, cashInCount, totalAmount }) => {
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
        ...
        {isExtraFeature && (
          <Row className="mb-2">
            ...
            <Col md={5} xxl={3} sm={6} className="mt-3 text-end">
                {
                  cashInCount && totalAmount && <div className="hstack gap-3 flex-wrap justify-content-end">
                    <div className="fs-16"> Cash In Count :{" "} <span className="fw-medium text-primary"> {cashInCount} </span></div> 
