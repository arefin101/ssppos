...
const TableContainer = ({ columns, data, isGlobalSearch, customPageSize, tableClass, theadClass, thClass, divClass, setFilteredData, isExtraFeature, maxLength, filteredLength, cashOutCount, totalAmount }) => {
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
    ...
    <Fragment>
        {isExtraFeature && (
          <Row className="mb-2">
            ...
            <Col md={5} xxl={8} sm={2}></Col>
            <Col md={5} xxl={3} sm={6} className="mt-3 text-end">
                {
                  cashOutCount && totalAmount && <div className="hstack gap-3 flex-wrap justify-content-end">
                    <div className="fs-16"> Cash Out Count :{" "} <span className="fw-medium text-primary"> {cashOutCount} </span></div> 
