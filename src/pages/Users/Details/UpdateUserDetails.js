...
import { getUserById, updateUserById } from '../../../store/actions';
...
const UpdateUserDetails = (props) => {
    ...
    const validation = useFormik({
        ...
        onSubmit: (values) => {
            ...
            dispatch(updateUserById(userId, formData, props.history));
        },
    ...
    useEffect(() => {
        if(error){
            if( 
                ...
                errornotify("User Information Update Failed !")
            }
        }
    }, [error]);
                ...
                <Container fluid>
                    ...
                    <Form className="needs-validation" onSubmit={(e) => validate(e)}>
                        ...
                        <div className='d-flex'>
                            ...
                            <Link className="mt-4 ms-3" to={"/user-details/" + userId}> 
