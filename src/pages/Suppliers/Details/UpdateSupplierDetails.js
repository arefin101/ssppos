...
const UpdateCustomerDetails = (props) => {
    ...
    const validation = useFormik({
        ...
        initialValues: {
            ...
            pin_number: "",
            business_name: userData.business_name === null ? "" : userData.business_name,
            business_website: userData.business_website === null ? "" : userData.business_website,
            contact_no: userData.contact_no,
            address: userData.address,
            city: userData.city,
            state: userData.state,
            country: userData.country,
            zip_code: userData.zip_code === null ? "" : userData.zip_code ,
        },
        ...
        onSubmit: (values) => {
            ...
            dispatch(updateSupplierById(userId, formData, props.history));
        },
    ...
    const {error}  =  useSelector( state => ({
        error: state.Contact.errorSupplier,
    }));
    ...
    useEffect(() => {
        if(error){
            if( 
                ...
                errornotify("Supplier Information Update Failed !")
            }
        }
    }, [error]);
                            ...
                            <CardBody>
                                <div className="live-preview">
                                    ...
                                    <div className='d-flex'>
                                        <Button color="primary" type="submit" className='mt-4 w-md'> Update </Button>
                                        <Link className="mt-4 ms-3" to={"/supplier-details/" + userId}> 
