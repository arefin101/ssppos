...
const SupplierTableData = ({history}) => {
    let data =[];
    let serial = 0;
                            ...
                            <div className="col-auto">
                                <ButtonGroup>
                                    <UncontrolledButtonDropdown id="btnGroupDrop1">
                                        ...
                                        <DropdownMenu>
                                            <DropdownItem onClick={() => supplierDetails(`/supplier-details/${row.cells[1].data}`)}><i style={{marginRight:'10px', verticalAlign: 'bottom' }} className='ri-eye-fill text-primary'></i> View </DropdownItem>
                                        </DropdownMenu>
